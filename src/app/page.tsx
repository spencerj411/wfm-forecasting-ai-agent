...
import { TrendingUp, Upload, MessageCircle, ArrowUpRight, BarChart3, CheckCircle } from "lucide-react"
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 py-20 sm:py-24 lg:py-32">
        <div className="max-w-5xl space-y-12 lg:space-y-16 animate-fade-in">
          ...
          <div className="pt-8 lg:pt-12">
            <Button
              asChild
              className="btn-primary text-white px-12 py-6 text-xl sm:text-2xl font-bold shadow-xl border-0"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            <div className="lg:col-span-6 order-2 lg:order-1 animate-fade-in">
              <Link href="/upload" className="block group">
                <div className="relative bg-gray-50/90 backdrop-blur-md card-rounded p-12 sm:p-16 lg:p-20 h-64 sm:h-80 lg:h-96 shadow-xl transform -rotate-2 scale-hover cursor-pointer">
                  <div className="flex flex-col items-center justify-center h-full space-y-8">
                    <div className="relative">
                      <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gray-500/10 rounded-full flex items-center justify-center">
                        <Upload className="h-10 w-10 sm:h-12 sm:w-12 text-gray-500" strokeWidth={1.5} />
                      </div>
                      <ArrowUpRight
                        className="absolute -top-2 -right-2 h-8 w-8 text-blue-600 opacity-70"
                        strokeWidth={1.5}
                      />
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div className="lg:col-span-6 animate-fade-in-delay-1">
              <Link href="/dashboard" className="block group">
                <div className="relative bg-green-50/40 backdrop-blur-md card-rounded p-12 sm:p-16 lg:p-20 h-64 sm:h-80 lg:h-96 shadow-xl transform rotate-2 scale-hover cursor-pointer border border-green-600/10">
                  <div className="flex flex-col items-center justify-center h-full space-y-8">
                    <div className="relative">
                    ...
                    <div className="text-center space-y-4">
                      ...
                      <p className="text-base sm:text-lg text-gray-600 max-w-sm leading-relaxed">
                        View detailed 7-day predictions with confidence intervals and trend analysis for better
                        planning.
                      </p>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            <div className="lg:col-span-6 order-2 lg:order-1 animate-fade-in-delay-2">
              <Link href="/chat" className="block group">
                <div className="relative bg-blue-50/40 backdrop-blur-md card-rounded p-12 sm:p-16 lg:p-20 h-64 sm:h-80 lg:h-96 shadow-xl transform -rotate-1 scale-hover cursor-pointer border border-blue-600/10">
                  <div className="flex flex-col items-center justify-center h-full space-y-8">
