    ...
    <PageWrapper>
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-24">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 animate-fade-in-delay-1">
        ...
        <div className="space-y-8 animate-fade-in-delay-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Link href="/chat" className="block lg:col-span-2 group">
              <Card className="h-full bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-2xl hover:scale-[1.02] transition-transform duration-300 flex flex-col justify-between p-8">
                <div>
                  ...
                  <p className="mt-4 text-lg text-blue-100 max-w-lg">
                    Engage in conversational, agentic forecasting. Ask questions, explore scenarios, and let your AI-powered analyst help you manage workforce demand and uncover actionable insights.
                  </p>
                </div>
            ...
            <div className="space-y-8">
              <Link href="/upload" className="block group">
                <Card className="h-full bg-gray-50/80 backdrop-blur-sm shadow-lg hover:shadow-xl border border-gray-200/80 hover:border-gray-300 transition-all duration-300 p-6">
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-blue-100/70 rounded-lg flex items-center justify-center">
                      <UploadCloud className="h-6 w-6 text-blue-600" strokeWidth={1.5} />
                    </div>
                    <div>
              ...
              <Link href="/dashboard" className="block group">
                <Card className="h-full bg-gray-50/80 backdrop-blur-sm shadow-lg hover:shadow-xl border border-gray-200/80 hover:border-gray-300 transition-all duration-300 p-6">
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-blue-100/70 rounded-lg flex items-center justify-center">
                      <LayoutDashboard className="h-6 w-6 text-blue-600" strokeWidth={1.5} />
                    </div>
                    <div>
