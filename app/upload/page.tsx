        ...
        <div className="lg:col-span-5 order-2 lg:order-1 animate-fade-in-delay-1">
          <Card className="bg-gray-50/90 backdrop-blur-md border-0 card-rounded shadow-xl h-full hover:scale-[1.02] transition-all duration-300">
            <CardHeader className="pb-6 sm:pb-8 pt-8 sm:pt-10 px-8 sm:px-10">
              <CardTitle className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 flex items-center space-x-3">
              ...
              <div className="space-y-8 sm:space-y-10">
                ...
                <div className="pt-4 sm:pt-6">
                  <button
                    ...
                    className="w-full btn-rounded border-gray-200 bg-white/90 backdrop-blur-sm hover:bg-gray-50 hover:scale-[1.02] transition-all duration-300 px-8 py-4 text-base sm:text-lg font-semibold flex items-center justify-center space-x-3 border-2 rounded-xl min-h-[48px] focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600"
            ...
            <CardContent className="px-8 sm:px-10 pb-8 sm:pb-10">
              <div className="space-y-8 sm:space-y-10 lg:space-y-12">
                ...
                <Button
                  ...
                  className="w-full btn-gradient btn-enhanced text-white shadow-lg disabled:opacity-50 disabled:cursor-not-allowed border-0 transition-all duration-300 hover:scale-[1.02] min-h-[56px] px-8"
